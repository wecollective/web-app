...
import About from '@pages/SpacePage/About'
import Calendar from '@pages/SpacePage/Calendar'
import Governance from '@pages/SpacePage/Governance'
import People from '@pages/SpacePage/People'
import Posts from '@pages/SpacePage/Posts'
import Rooms from '@pages/SpacePage/Rooms'
import Settings from '@pages/SpacePage/Settings'
import Spaces from '@pages/SpacePage/Spaces'
